...
public:
        ...
        AudioEffectPhaser() : AudioStream(1, inputQueueArray), queue(3000 + OSCILLATION_AMP + 128)
        {
            on = false;
            delayAmount = 300;
            sine_idx = 0;
        ...
        void begin(short delay_length, short oscil_rate_in = 20);
