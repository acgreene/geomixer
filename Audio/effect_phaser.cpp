...
void AudioEffectPhaser::update(void)
{
    ...
    else if(on)
    {
        ...
        int increment = (2.0 * (0.015) * (float)delayAmount * 2147483648.0)/ AUDIO_SAMPLE_RATE_EXACT;
...
void AudioEffectPhaser::begin(short delay_length=220, short oscil_rate_in = 20)
{
    this->on = true;
